...
export const SOURCES = {
  ...
  A6:  { pub: 'Apple Support', title: 'Translate texts in Messages on iPhone', url: 'https://support.apple.com/en-gb/guide/iphone/iphyrz4rgtgk/ios', date: null },
  A7:  { pub: 'Apple Support', title: 'See translations during phone calls on iPhone', url: 'https://support.apple.com/en-gb/guide/iphone/ly3pl0v38sek/ios', date: null },
  A17: { pub: 'Apple Support', title: 'Use Live Captions and Live Translation in FaceTime on iPhone', url: 'https://support.apple.com/en-gb/guide/iphone/iphb41156356/ios', date: null },
  ...
  S31: { pub: 'Apple', title: 'iPhone 18 Pro technical specifications (Germany), incl. EU energy-label battery capacity', url: 'https://www.apple.com/de/iphone-18-pro/specs/', date: null },
  ...
  P05: { pub: 'Apple Support', title: 'Delete certain built-in apps in the EU or Japan', url: 'https://support.apple.com/en-us/121327', date: '2026-01-26' },
  ...
  P17: { pub: 'Apple Developer', title: 'Using alternative browser engines in Japan', url: 'https://developer.apple.com/support/alternative-browser-engines-jp/', date: null },
  ...
  R3:  { pub: 'Apple Newsroom', title: 'Apple Vision Pro upgraded with the M5 chip (country list footnote)', url: 'https://www.apple.com/newsroom/2025/10/apple-vision-pro-upgraded-with-the-m5-chip-and-dual-knit-band/', date: '2025-10-15' },
  ...
  X2:  { pub: 'European Central Bank', title: 'Euro foreign exchange reference rates (daily), 25 Sep 2025 to 24 Sep 2026', url: 'https://data-api.ecb.europa.eu/service/data/EXR/D.USD+DKK+SEK+PLN+CZK+HUF.EUR.SP00.A?startPeriod=2025-09-25&endPeriod=2026-09-24&format=csvdata', date: '2026-09-24' },
  T1:  { pub: 'iFixit', title: 'Inside the Tiny Unfixable Eye: iPhone 18 Pro and Pro Max teardown (eSIM-model battery labels)', url: 'https://www.ifixit.com/News/119329/inside-the-tiny-unfixable-eye-iphone-18-pro-and-pro-max-teardown', date: '2026-09-20' },
  R10: { pub: 'Apple Newsroom', title: 'Apple expands Self Service Repair', url: 'https://www.apple.com/newsroom/2023/12/apple-expands-self-service-repair-and-introduces-new-diagnostics-process/', date: '2023-12-13' },
  R5:  { pub: 'Apple', title: 'Apple One pages for the other EU storefronts (apple.com/<country>/apple-one)', url: 'https://www.apple.com/ie/apple-one/', date: null, note: 'AT, BE, CZ, FI, HU, IE, IT, LU, PL, PT, ES; extracts in research/raw.' },
  X3:  { pub: 'Tax Foundation', title: 'State and Local Sales Tax Rates, Midyear 2026', url: 'https://taxfoundation.org/data/all/state/2026-sales-tax-rates-midyear/', date: '2026-07-06' },
};
